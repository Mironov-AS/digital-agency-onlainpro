...
.method final a(I)V
    ...
    iget-object v3, p1, Landroid/support/v7/widget/x;->q:Landroid/widget/PopupWindow;
    ...
    invoke-virtual {p1, v0}, Landroid/support/v7/widget/x;->b(I)V

    invoke-virtual {p1}, Landroid/support/v7/widget/x;->b()V
    ...
    :cond_4
    iget-object v0, p1, Landroid/support/v7/widget/x;->e:Landroid/support/v7/widget/t;
...
.method final getListPopupWindow()Landroid/support/v7/widget/x;
    .locals 2
    ...
    iput-object p0, v0, Landroid/support/v7/widget/x;->k:Landroid/view/View;

    invoke-virtual {v0}, Landroid/support/v7/widget/x;->f()V

    iget-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->n:Landroid/support/v7/widget/x;

    iget-object v1, p0, Landroid/support/v7/widget/ActivityChooserView;->i:Landroid/support/v7/widget/ActivityChooserView$b;

    iput-object v1, v0, Landroid/support/v7/widget/x;->l:Landroid/widget/AdapterView$OnItemClickListener;
...
.method public final setActivityChooserModel(Landroid/support/v7/widget/d;)V
    ...
    iget-object p1, p1, Landroid/support/v7/widget/x;->q:Landroid/widget/PopupWindow;
