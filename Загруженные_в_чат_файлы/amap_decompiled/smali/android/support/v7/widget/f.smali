...
.method private a(Landroid/graphics/drawable/Drawable;)Z
    ...
    iget-object v0, p0, Landroid/support/v7/widget/f;->f:Landroid/support/v7/widget/ag;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/f;->f:Landroid/support/v7/widget/ag;
    ...
    invoke-static {v1}, Landroid/support/v4/f/m;->f(Landroid/view/View;)Landroid/content/res/ColorStateList;
    ...
    invoke-static {v1}, Landroid/support/v4/f/m;->g(Landroid/view/View;)Landroid/graphics/PorterDuff$Mode;
...
.method private b(Landroid/content/res/ColorStateList;)V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/f;->d:Landroid/support/v7/widget/ag;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/f;->d:Landroid/support/v7/widget/ag;
    ...
    iput-object p1, p0, Landroid/support/v7/widget/f;->d:Landroid/support/v7/widget/ag;
...
.method final a(Landroid/content/res/ColorStateList;)V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/f;->e:Landroid/support/v7/widget/ag;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/f;->e:Landroid/support/v7/widget/ag;
...
.method final a(Landroid/util/AttributeSet;I)V
    ...
    invoke-static {v0, p1, v1, p2, v2}, Landroid/support/v7/widget/ai;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/widget/ai;
    ...
    invoke-virtual {p1, p2, v0}, Landroid/support/v7/widget/ai;->g(II)I
    ...
    invoke-virtual {p1, v1}, Landroid/support/v7/widget/ai;->d(I)Landroid/content/res/ColorStateList;

    move-result-object v1

    invoke-static {p2, v1}, Landroid/support/v4/f/m;->a(Landroid/view/View;Landroid/content/res/ColorStateList;)V
    ...
    invoke-static {p2, v0}, Landroid/support/v4/f/m;->a(Landroid/view/View;Landroid/graphics/PorterDuff$Mode;)V
    :try_end_0
...
.method final d()V
    ...
    :cond_0
    iget-object v1, p0, Landroid/support/v7/widget/f;->e:Landroid/support/v7/widget/ag;
    ...
    :cond_1
    iget-object v1, p0, Landroid/support/v7/widget/f;->d:Landroid/support/v7/widget/ag;
