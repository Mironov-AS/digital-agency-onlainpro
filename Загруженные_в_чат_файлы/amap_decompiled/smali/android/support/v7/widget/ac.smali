...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v7/widget/ac;->i:Landroid/view/animation/Interpolator;
...
.method protected final onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    invoke-virtual {p0, v1}, Landroid/support/v7/widget/ac;->setContentHeight(I)V
...
.method public final onMeasure(II)V
    ...
    :cond_3
    iput v5, p0, Landroid/support/v7/widget/ac;->c:I

    :goto_2
    iget p2, p0, Landroid/support/v7/widget/ac;->e:I
    ...
    invoke-virtual {v0, v1, p2}, Landroid/support/v7/widget/w;->measure(II)V
    ...
    invoke-direct {v0, v2, v4}, Landroid/support/v7/widget/n;-><init>(Landroid/content/Context;I)V

    new-instance v2, Landroid/support/v7/widget/w$a;

    invoke-direct {v2, v1, v5}, Landroid/support/v7/widget/w$a;-><init>(II)V
    ...
    :cond_8
    invoke-direct {p0}, Landroid/support/v7/widget/ac;->b()Z
    ...
    iget p1, p0, Landroid/support/v7/widget/ac;->h:I
...
.method public final setTabSelected(I)V
    ...
    invoke-virtual {v3, p1}, Landroid/support/v7/widget/w;->getChildAt(I)Landroid/view/View;

    move-result-object v3

    iget-object v4, p0, Landroid/support/v7/widget/ac;->a:Ljava/lang/Runnable;

    if-eqz v4, :cond_1

    invoke-virtual {p0, v4}, Landroid/support/v7/widget/ac;->removeCallbacks(Ljava/lang/Runnable;)Z

    :cond_1
    new-instance v4, Landroid/support/v7/widget/ac$1;

    invoke-direct {v4, p0, v3}, Landroid/support/v7/widget/ac$1;-><init>(Landroid/support/v7/widget/ac;Landroid/view/View;)V

    iput-object v4, p0, Landroid/support/v7/widget/ac;->a:Ljava/lang/Runnable;

    iget-object v3, p0, Landroid/support/v7/widget/ac;->a:Ljava/lang/Runnable;

    invoke-virtual {p0, v3}, Landroid/support/v7/widget/ac;->post(Ljava/lang/Runnable;)Z
