...
.method constructor <init>()V
    ...
    iput v0, p0, Landroid/support/v7/c/a/b;->b:I
...
.method protected a(Landroid/support/v7/c/a/b$b;)V
    ...
    iget-object p1, p0, Landroid/support/v7/c/a/b;->d:Landroid/graphics/drawable/Drawable;
    ...
    iput-object p1, p0, Landroid/support/v7/c/a/b;->e:Landroid/graphics/drawable/Drawable;
...
.method final a(Z)V
    ...
    iget v9, p0, Landroid/support/v7/c/a/b;->f:I
    ...
    iget v10, p0, Landroid/support/v7/c/a/b;->f:I
    ...
    :goto_1
    iget-object v9, p0, Landroid/support/v7/c/a/b;->e:Landroid/graphics/drawable/Drawable;
    ...
    iget v5, p0, Landroid/support/v7/c/a/b;->f:I
...
.method final a(I)Z
    ...
    :cond_2
    iput-object v5, p0, Landroid/support/v7/c/a/b;->e:Landroid/graphics/drawable/Drawable;
    ...
    iput v4, p0, Landroid/support/v7/c/a/b;->b:I
...
.method public applyTheme(Landroid/content/res/Resources$Theme;)V
    ...
    invoke-virtual {v0}, Landroid/support/v7/c/a/b$b;->c()V

    iget v1, v0, Landroid/support/v7/c/a/b$b;->j:I

    iget-object v2, v0, Landroid/support/v7/c/a/b$b;->i:[Landroid/graphics/drawable/Drawable;
    ...
    iget v4, v0, Landroid/support/v7/c/a/b$b;->g:I
    ...
    iput v4, v0, Landroid/support/v7/c/a/b$b;->g:I
...
.method public getOpacity()I
    ...
    iget-boolean v2, v0, Landroid/support/v7/c/a/b$b;->t:Z

    if-eqz v2, :cond_1

    iget v0, v0, Landroid/support/v7/c/a/b$b;->u:I
    ...
    iget v2, v0, Landroid/support/v7/c/a/b$b;->j:I

    iget-object v3, v0, Landroid/support/v7/c/a/b$b;->i:[Landroid/graphics/drawable/Drawable;
    ...
    :cond_3
    iput v5, v0, Landroid/support/v7/c/a/b$b;->u:I

    iput-boolean v4, v0, Landroid/support/v7/c/a/b$b;->t:Z
...
.method public getPadding(Landroid/graphics/Rect;)Z
    ...
    iget-boolean v1, v0, Landroid/support/v7/c/a/b$b;->k:Z
    ...
    :cond_0
    iget-object v1, v0, Landroid/support/v7/c/a/b$b;->m:Landroid/graphics/Rect;
    ...
    iget v5, v0, Landroid/support/v7/c/a/b$b;->j:I

    iget-object v6, v0, Landroid/support/v7/c/a/b$b;->i:[Landroid/graphics/drawable/Drawable;
    ...
    :cond_7
    iput-boolean v3, v0, Landroid/support/v7/c/a/b$b;->l:Z

    iput-object v7, v0, Landroid/support/v7/c/a/b$b;->m:Landroid/graphics/Rect;
    ...
    :cond_8
    :goto_1
    iget-object v2, v0, Landroid/support/v7/c/a/b$b;->m:Landroid/graphics/Rect;
...
.method public isStateful()Z
    ...
    iget-boolean v1, v0, Landroid/support/v7/c/a/b$b;->v:Z
    ...
    :cond_2
    :goto_1
    iput-boolean v3, v0, Landroid/support/v7/c/a/b$b;->w:Z

    iput-boolean v5, v0, Landroid/support/v7/c/a/b$b;->v:Z
...
.method public onLayoutDirectionChanged(I)Z
    ...
    iget v1, p0, Landroid/support/v7/c/a/b;->b:I
    ...
    :cond_2
    iput p1, v0, Landroid/support/v7/c/a/b$b;->B:I
