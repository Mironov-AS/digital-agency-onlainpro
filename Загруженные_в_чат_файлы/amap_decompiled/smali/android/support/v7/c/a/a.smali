...
.method public static a(Landroid/content/Context;Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)Landroid/support/v7/c/a/a;
    ...
    invoke-direct/range {v2 .. v7}, Landroid/support/v7/c/a/a;->b(Landroid/content/Context;Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)V

    invoke-virtual {v0}, Landroid/support/v7/c/a/a;->getState()[I

    move-result-object p0

    invoke-virtual {v0, p0}, Landroid/support/v7/c/a/a;->onStateChange([I)Z
...
.method private b(Landroid/content/Context;Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)V
    ...
    sget-object v3, Landroid/support/v7/a/a$j;->AnimatedStateListDrawableItem:[I

    move-object/from16 v4, p2

    move-object/from16 v6, p5

    invoke-static {v4, v6, v0, v3}, Landroid/support/v4/a/a/g;->a(Landroid/content/res/Resources;Landroid/content/res/Resources$Theme;Landroid/util/AttributeSet;[I)Landroid/content/res/TypedArray;

    move-result-object v3

    sget v7, Landroid/support/v7/a/a$j;->AnimatedStateListDrawableItem_android_id:I
    ...
    sget v10, Landroid/support/v7/a/a$j;->AnimatedStateListDrawableItem_android_drawable:I
    ...
    invoke-static {v11, v10}, Landroid/support/v7/b/a/a;->b(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static/range {p2 .. p5}, Landroid/support/b/a/i;->a(Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)Landroid/support/b/a/i;
    ...
    iget-object v8, v5, Landroid/support/v7/c/a/a;->d:Landroid/support/v7/c/a/a$b;

    invoke-virtual {v8, v9}, Landroid/support/v7/c/a/d$a;->a(Landroid/graphics/drawable/Drawable;)I

    move-result v9

    iget-object v10, v8, Landroid/support/v7/c/a/d$a;->L:[[I

    aput-object v3, v10, v9

    iget-object v3, v8, Landroid/support/v7/c/a/a$b;->b:Landroid/support/v4/e/i;

    invoke-static {v7}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;

    move-result-object v7

    invoke-virtual {v3, v9, v7}, Landroid/support/v4/e/i;->b(ILjava/lang/Object;)V
...
.method private c(Landroid/content/Context;Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)I
    ...
    iget-object p1, p0, Landroid/support/v7/c/a/a;->d:Landroid/support/v7/c/a/a$b;
...
.method protected onStateChange([I)Z
    ...
    invoke-virtual {v2, v1}, Landroid/support/v7/c/a/a$b;->a([I)I

    move-result v2

    iget v3, v0, Landroid/support/v7/c/a/b;->b:I
    ...
    iget-object v3, v0, Landroid/support/v7/c/a/a;->e:Landroid/support/v7/c/a/a$f;

    if-eqz v3, :cond_2

    iget v6, v0, Landroid/support/v7/c/a/a;->f:I
    ...
    :cond_0
    iget v6, v0, Landroid/support/v7/c/a/a;->g:I

    if-ne v2, v6, :cond_1

    invoke-virtual {v3}, Landroid/support/v7/c/a/a$f;->c()Z

    move-result v6

    if-eqz v6, :cond_1

    invoke-virtual {v3}, Landroid/support/v7/c/a/a$f;->d()V

    iget v3, v0, Landroid/support/v7/c/a/a;->g:I

    iput v3, v0, Landroid/support/v7/c/a/a;->f:I

    iput v2, v0, Landroid/support/v7/c/a/a;->g:I
    ...
    invoke-virtual {v3}, Landroid/support/v7/c/a/a$f;->b()V

    goto :goto_1

    :cond_2
    iget v6, v0, Landroid/support/v7/c/a/b;->b:I

    :goto_1
    const/4 v3, 0x0

    iput-object v3, v0, Landroid/support/v7/c/a/a;->e:Landroid/support/v7/c/a/a$f;

    const/4 v3, -0x1

    iput v3, v0, Landroid/support/v7/c/a/a;->g:I

    iput v3, v0, Landroid/support/v7/c/a/a;->f:I

    iget-object v3, v0, Landroid/support/v7/c/a/a;->d:Landroid/support/v7/c/a/a$b;

    invoke-virtual {v3, v6}, Landroid/support/v7/c/a/a$b;->a(I)I

    move-result v7

    invoke-virtual {v3, v2}, Landroid/support/v7/c/a/a$b;->a(I)I
    ...
    :cond_3
    invoke-static {v7, v8}, Landroid/support/v7/c/a/a$b;->a(II)J

    move-result-wide v9

    iget-object v11, v3, Landroid/support/v7/c/a/a$b;->a:Landroid/support/v4/e/c;
    ...
    invoke-virtual {v11, v9, v10, v14}, Landroid/support/v4/e/c;->a(JLjava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v9, v3, Landroid/support/v7/c/a/a$b;->a:Landroid/support/v4/e/c;

    invoke-static {v12, v13}, Ljava/lang/Long;->valueOf(J)Ljava/lang/Long;

    move-result-object v11

    invoke-virtual {v9, v14, v15, v11}, Landroid/support/v4/e/c;->a(JLjava/lang/Object;)Ljava/lang/Object;
    ...
    :goto_2
    invoke-virtual {v0, v10}, Landroid/support/v7/c/a/a;->a(I)Z

    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/c/a/a;->getCurrent()Landroid/graphics/drawable/Drawable;
    ...
    iget-object v3, v3, Landroid/support/v7/c/a/a$b;->a:Landroid/support/v4/e/c;

    invoke-static {v12, v13}, Ljava/lang/Long;->valueOf(J)Ljava/lang/Long;

    move-result-object v11

    invoke-virtual {v3, v7, v8, v11}, Landroid/support/v4/e/c;->a(JLjava/lang/Object;)Ljava/lang/Object;
    ...
    :goto_3
    new-instance v7, Landroid/support/v7/c/a/a$d;

    check-cast v10, Landroid/graphics/drawable/AnimationDrawable;

    invoke-direct {v7, v10, v3, v9}, Landroid/support/v7/c/a/a$d;-><init>(Landroid/graphics/drawable/AnimationDrawable;ZZ)V

    goto :goto_4

    :cond_7
    instance-of v3, v10, Landroid/support/b/a/c;

    if-eqz v3, :cond_8

    new-instance v7, Landroid/support/v7/c/a/a$c;

    check-cast v10, Landroid/support/b/a/c;

    invoke-direct {v7, v10}, Landroid/support/v7/c/a/a$c;-><init>(Landroid/support/b/a/c;)V
    ...
    new-instance v7, Landroid/support/v7/c/a/a$a;

    check-cast v10, Landroid/graphics/drawable/Animatable;

    invoke-direct {v7, v10}, Landroid/support/v7/c/a/a$a;-><init>(Landroid/graphics/drawable/Animatable;)V

    :goto_4
    invoke-virtual {v7}, Landroid/support/v7/c/a/a$f;->a()V

    iput-object v7, v0, Landroid/support/v7/c/a/a;->e:Landroid/support/v7/c/a/a$f;

    iput v6, v0, Landroid/support/v7/c/a/a;->g:I

    iput v2, v0, Landroid/support/v7/c/a/a;->f:I
    ...
    invoke-virtual {v0, v2}, Landroid/support/v7/c/a/a;->a(I)Z
...
.method public setVisible(ZZ)Z
    ...
    iget-object p1, p0, Landroid/support/v7/c/a/a;->e:Landroid/support/v7/c/a/a$f;
