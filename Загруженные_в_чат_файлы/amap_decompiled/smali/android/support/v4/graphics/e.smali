.class final Landroid/support/v4/graphics/e;
...
.method public final a(Landroid/content/Context;Landroid/support/v4/a/a/c$b;Landroid/content/res/Resources;I)Landroid/graphics/Typeface;
    ...
    iget v3, v2, Landroid/support/v4/a/a/c$c;->f:I
    ...
    :cond_0
    iget v5, v2, Landroid/support/v4/a/a/c$c;->e:I

    iget v6, v2, Landroid/support/v4/a/a/c$c;->b:I

    iget-boolean v2, v2, Landroid/support/v4/a/a/c$c;->c:Z
...
.method public final a(Landroid/content/Context;[Landroid/support/v4/c/b$b;I)Landroid/graphics/Typeface;
    ...
    invoke-direct {v1}, Landroid/support/v4/e/h;-><init>()V
    ...
    iget-object v5, v4, Landroid/support/v4/c/b$b;->a:Landroid/net/Uri;

    invoke-virtual {v1, v5}, Landroid/support/v4/e/h;->get(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-static {p1, v5}, Landroid/support/v4/graphics/i;->a(Landroid/content/Context;Landroid/net/Uri;)Ljava/nio/ByteBuffer;

    move-result-object v6

    invoke-virtual {v1, v5, v6}, Landroid/support/v4/e/h;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    :cond_0
    iget v5, v4, Landroid/support/v4/c/b$b;->b:I

    iget v7, v4, Landroid/support/v4/c/b$b;->c:I

    iget-boolean v4, v4, Landroid/support/v4/c/b$b;->d:Z
