...
.method public constructor <init>()V
    ...
    invoke-virtual {p0, v1}, Landroid/support/v4/graphics/f;->a(Ljava/lang/Class;)Ljava/lang/reflect/Method;
    ...
    iput-object v3, p0, Landroid/support/v4/graphics/f;->b:Ljava/lang/reflect/Constructor;

    iput-object v4, p0, Landroid/support/v4/graphics/f;->c:Ljava/lang/reflect/Method;

    iput-object v5, p0, Landroid/support/v4/graphics/f;->d:Ljava/lang/reflect/Method;

    iput-object v6, p0, Landroid/support/v4/graphics/f;->e:Ljava/lang/reflect/Method;
...
.method public final a(Landroid/content/Context;Landroid/content/res/Resources;ILjava/lang/String;I)Landroid/graphics/Typeface;
    ...
    invoke-direct {p0}, Landroid/support/v4/graphics/f;->a()Z
    ...
    :cond_0
    invoke-direct {p0}, Landroid/support/v4/graphics/f;->b()Ljava/lang/Object;
...
.method public final a(Landroid/content/Context;Landroid/support/v4/a/a/c$b;Landroid/content/res/Resources;I)Landroid/graphics/Typeface;
    .locals 10
    ...
    iget-object p2, p2, Landroid/support/v4/a/a/c$b;->a:[Landroid/support/v4/a/a/c$c;
    ...
    iget-object v3, v0, Landroid/support/v4/a/a/c$c;->a:Ljava/lang/String;

    iget v4, v0, Landroid/support/v4/a/a/c$c;->e:I

    iget v5, v0, Landroid/support/v4/a/a/c$c;->b:I

    iget-boolean v6, v0, Landroid/support/v4/a/a/c$c;->c:Z

    iget-object v0, v0, Landroid/support/v4/a/a/c$c;->d:Ljava/lang/String;
...
.method public final a(Landroid/content/Context;[Landroid/support/v4/c/b$b;I)Landroid/graphics/Typeface;
    ...
    invoke-virtual {p0, p2, p3}, Landroid/support/v4/graphics/f;->a([Landroid/support/v4/c/b$b;I)Landroid/support/v4/c/b$b;
    ...
    :try_start_0
    iget-object p3, p2, Landroid/support/v4/c/b$b;->a:Landroid/net/Uri;
    ...
    iget-object v4, v3, Landroid/support/v4/c/b$b;->a:Landroid/net/Uri;
    ...
    iget v5, v3, Landroid/support/v4/c/b$b;->b:I

    iget v6, v3, Landroid/support/v4/c/b$b;->c:I

    iget-boolean v7, v3, Landroid/support/v4/c/b$b;->d:Z
    ...
    invoke-direct {p0, v0}, Landroid/support/v4/graphics/f;->c(Ljava/lang/Object;)V
    ...
    :cond_a
    invoke-direct {p0, v0}, Landroid/support/v4/graphics/f;->b(Ljava/lang/Object;)Z
    ...
    :cond_b
    invoke-virtual {p0, v0}, Landroid/support/v4/graphics/f;->a(Ljava/lang/Object;)Landroid/graphics/Typeface;
