...
.method private a(Landroid/support/b/a/i$c;Landroid/graphics/Matrix;Landroid/graphics/Canvas;IILandroid/graphics/ColorFilter;)V
    ...
    iget v3, v7, Landroid/support/b/a/i$f;->f:F
    ...
    iget v5, v7, Landroid/support/b/a/i$f;->g:F
    ...
    iget-object v13, v7, Landroid/support/b/a/i$f;->o:Landroid/graphics/Matrix;
    ...
    iget-object v6, v5, Landroid/support/b/a/i$f;->l:Landroid/graphics/Path;

    invoke-virtual {v0, v6}, Landroid/support/b/a/i$e;->a(Landroid/graphics/Path;)V

    iget-object v6, v5, Landroid/support/b/a/i$f;->l:Landroid/graphics/Path;

    iget-object v7, v5, Landroid/support/b/a/i$f;->m:Landroid/graphics/Path;

    invoke-virtual {v7}, Landroid/graphics/Path;->reset()V

    invoke-virtual {v0}, Landroid/support/b/a/i$e;->a()Z

    move-result v7

    if-eqz v7, :cond_2

    iget-object v0, v5, Landroid/support/b/a/i$f;->m:Landroid/graphics/Path;

    iget-object v2, v5, Landroid/support/b/a/i$f;->o:Landroid/graphics/Matrix;
    ...
    iget-object v13, v5, Landroid/support/b/a/i$f;->p:Landroid/graphics/PathMeasure;
    ...
    iput-object v13, v5, Landroid/support/b/a/i$f;->p:Landroid/graphics/PathMeasure;

    :cond_4
    iget-object v13, v5, Landroid/support/b/a/i$f;->p:Landroid/graphics/PathMeasure;

    iget-object v15, v5, Landroid/support/b/a/i$f;->l:Landroid/graphics/Path;
    ...
    iget-object v15, v5, Landroid/support/b/a/i$f;->p:Landroid/graphics/PathMeasure;

    const/4 v11, 0x1

    invoke-virtual {v15, v7, v13, v6, v11}, Landroid/graphics/PathMeasure;->getSegment(FFLandroid/graphics/Path;Z)Z

    iget-object v7, v5, Landroid/support/b/a/i$f;->p:Landroid/graphics/PathMeasure;
    ...
    :cond_6
    iget-object v4, v5, Landroid/support/b/a/i$f;->m:Landroid/graphics/Path;

    iget-object v7, v5, Landroid/support/b/a/i$f;->o:Landroid/graphics/Matrix;

    invoke-virtual {v4, v6, v7}, Landroid/graphics/Path;->addPath(Landroid/graphics/Path;Landroid/graphics/Matrix;)V

    iget-object v4, v0, Landroid/support/b/a/i$b;->c:Landroid/support/v4/a/a/b;

    invoke-virtual {v4}, Landroid/support/v4/a/a/b;->c()Z
    ...
    iget-object v7, v5, Landroid/support/b/a/i$f;->b:Landroid/graphics/Paint;
    ...
    iput-object v7, v5, Landroid/support/b/a/i$f;->b:Landroid/graphics/Paint;
    ...
    invoke-virtual {v4}, Landroid/support/v4/a/a/b;->a()Z

    move-result v11

    if-eqz v11, :cond_8

    iget-object v4, v4, Landroid/support/v4/a/a/b;->a:Landroid/graphics/Shader;

    iget-object v11, v5, Landroid/support/b/a/i$f;->o:Landroid/graphics/Matrix;
    ...
    iget v4, v0, Landroid/support/b/a/i$b;->f:F
    ...
    :cond_8
    iget v4, v4, Landroid/support/v4/a/a/b;->b:I

    iget v11, v0, Landroid/support/b/a/i$b;->f:F

    invoke-static {v4, v11}, Landroid/support/b/a/i;->a(IF)I
    ...
    iget v11, v0, Landroid/support/b/a/i$b;->e:I
    ...
    :cond_a
    iget-object v4, v0, Landroid/support/b/a/i$b;->a:Landroid/support/v4/a/a/b;
    ...
    iget-object v7, v5, Landroid/support/b/a/i$f;->a:Landroid/graphics/Paint;
    ...
    iput-object v7, v5, Landroid/support/b/a/i$f;->a:Landroid/graphics/Paint;
    ...
    iget-object v11, v0, Landroid/support/b/a/i$b;->k:Landroid/graphics/Paint$Join;
    ...
    :cond_c
    iget-object v11, v0, Landroid/support/b/a/i$b;->j:Landroid/graphics/Paint$Cap;
    ...
    :cond_d
    iget v11, v0, Landroid/support/b/a/i$b;->l:F
    ...
    iget v4, v0, Landroid/support/b/a/i$b;->d:F
    ...
    iget v6, v0, Landroid/support/b/a/i$b;->d:F

    invoke-static {v4, v6}, Landroid/support/b/a/i;->a(IF)I
