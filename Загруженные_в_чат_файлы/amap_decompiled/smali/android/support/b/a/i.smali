...
# instance fields
.field b:Landroid/support/b/a/i$g;
...
.method private b(Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)V
    ...
    iget-object v5, v3, Landroid/support/b/a/i;->b:Landroid/support/b/a/i$g;

    iget-object v6, v5, Landroid/support/b/a/i$g;->b:Landroid/support/b/a/i$f;

    new-instance v7, Ljava/util/ArrayDeque;

    invoke-direct {v7}, Ljava/util/ArrayDeque;-><init>()V

    iget-object v8, v6, Landroid/support/b/a/i$f;->c:Landroid/support/b/a/i$c;
    ...
    invoke-static {v0, v4, v2, v11}, Landroid/support/v4/a/a/g;->a(Landroid/content/res/Resources;Landroid/content/res/Resources$Theme;Landroid/util/AttributeSet;[I)Landroid/content/res/TypedArray;

    move-result-object v11

    invoke-virtual {v8, v11, v1, v4}, Landroid/support/b/a/i$b;->a(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Landroid/content/res/Resources$Theme;)V
    ...
    iget-object v11, v6, Landroid/support/b/a/i$f;->k:Landroid/support/v4/e/a;
    ...
    :cond_1
    iget v11, v5, Landroid/support/b/a/i$g;->a:I

    iget v8, v8, Landroid/support/b/a/i$b;->o:I

    or-int/2addr v8, v11

    iput v8, v5, Landroid/support/b/a/i$g;->a:I
    ...
    invoke-static {v1, v12}, Landroid/support/v4/a/a/g;->a(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;)Z
    ...
    invoke-static {v0, v4, v2, v12}, Landroid/support/v4/a/a/g;->a(Landroid/content/res/Resources;Landroid/content/res/Resources$Theme;Landroid/util/AttributeSet;[I)Landroid/content/res/TypedArray;
    ...
    iget-object v12, v6, Landroid/support/b/a/i$f;->k:Landroid/support/v4/e/a;
    ...
    :cond_4
    iget v12, v5, Landroid/support/b/a/i$g;->a:I
    ...
    invoke-static {v12, v1, v13, v14, v10}, Landroid/support/v4/a/a/g;->a(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;IF)F
    ...
    invoke-static {v12, v1, v10, v13, v14}, Landroid/support/v4/a/a/g;->a(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;IF)F
    ...
    iget-object v10, v6, Landroid/support/b/a/i$f;->k:Landroid/support/v4/e/a;
    ...
    :cond_7
    iget v10, v5, Landroid/support/b/a/i$g;->a:I
...
.method public final draw(Landroid/graphics/Canvas;)V
    ...
    iget-object v6, p0, Landroid/support/b/a/i;->b:Landroid/support/b/a/i$g;

    iget-object v7, v6, Landroid/support/b/a/i$g;->f:Landroid/graphics/Bitmap;
    ...
    iput-object v7, v6, Landroid/support/b/a/i$g;->f:Landroid/graphics/Bitmap;

    iput-boolean v5, v6, Landroid/support/b/a/i$g;->k:Z
    ...
    invoke-virtual {v6, v1, v3}, Landroid/support/b/a/i$g;->a(II)V
    ...
    iget-boolean v7, v6, Landroid/support/b/a/i$g;->k:Z

    if-nez v7, :cond_c

    iget-object v7, v6, Landroid/support/b/a/i$g;->g:Landroid/content/res/ColorStateList;

    iget-object v8, v6, Landroid/support/b/a/i$g;->c:Landroid/content/res/ColorStateList;

    if-ne v7, v8, :cond_c

    iget-object v7, v6, Landroid/support/b/a/i$g;->h:Landroid/graphics/PorterDuff$Mode;

    iget-object v8, v6, Landroid/support/b/a/i$g;->d:Landroid/graphics/PorterDuff$Mode;

    if-ne v7, v8, :cond_c

    iget-boolean v7, v6, Landroid/support/b/a/i$g;->j:Z

    iget-boolean v8, v6, Landroid/support/b/a/i$g;->e:Z

    if-ne v7, v8, :cond_c

    iget v7, v6, Landroid/support/b/a/i$g;->i:I

    iget-object v6, v6, Landroid/support/b/a/i$g;->b:Landroid/support/b/a/i$f;
    ...
    iget-object v3, v1, Landroid/support/b/a/i$g;->c:Landroid/content/res/ColorStateList;

    iput-object v3, v1, Landroid/support/b/a/i$g;->g:Landroid/content/res/ColorStateList;

    iget-object v3, v1, Landroid/support/b/a/i$g;->d:Landroid/graphics/PorterDuff$Mode;

    iput-object v3, v1, Landroid/support/b/a/i$g;->h:Landroid/graphics/PorterDuff$Mode;

    iget-object v3, v1, Landroid/support/b/a/i$g;->b:Landroid/support/b/a/i$f;

    invoke-virtual {v3}, Landroid/support/b/a/i$f;->getRootAlpha()I

    move-result v3

    iput v3, v1, Landroid/support/b/a/i$g;->i:I

    iget-boolean v3, v1, Landroid/support/b/a/i$g;->e:Z

    iput-boolean v3, v1, Landroid/support/b/a/i$g;->j:Z

    iput-boolean v2, v1, Landroid/support/b/a/i$g;->k:Z
    ...
    iget-object v6, v1, Landroid/support/b/a/i$g;->b:Landroid/support/b/a/i$f;
    ...
    :cond_f
    iget-object v2, v1, Landroid/support/b/a/i$g;->l:Landroid/graphics/Paint;
    ...
    iput-object v2, v1, Landroid/support/b/a/i$g;->l:Landroid/graphics/Paint;
    ...
    iget-object v5, v1, Landroid/support/b/a/i$g;->b:Landroid/support/b/a/i$f;
    ...
    iget-object v0, v1, Landroid/support/b/a/i$g;->l:Landroid/graphics/Paint;

    :goto_4
    iget-object v1, v1, Landroid/support/b/a/i$g;->f:Landroid/graphics/Bitmap;
...
.method public final inflate(Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)V
    ...
    iget-object v3, v2, Landroid/support/b/a/i$g;->b:Landroid/support/b/a/i$f;
    ...
    invoke-static {v1, p2, v4, v5, v6}, Landroid/support/v4/a/a/g;->a(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;II)I
    ...
    :goto_0
    iput-object v5, v2, Landroid/support/b/a/i$g;->d:Landroid/graphics/PorterDuff$Mode;
    ...
    iput-object v5, v2, Landroid/support/b/a/i$g;->c:Landroid/content/res/ColorStateList;

    :cond_4
    const-string v5, "autoMirrored"

    iget-boolean v8, v2, Landroid/support/b/a/i$g;->e:Z
    ...
    :goto_1
    iput-boolean v8, v2, Landroid/support/b/a/i$g;->e:Z

    const-string v2, "viewportWidth"

    const/4 v5, 0x7

    iget v6, v3, Landroid/support/b/a/i$f;->f:F

    invoke-static {v1, p2, v2, v5, v6}, Landroid/support/v4/a/a/g;->a(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;IF)F

    move-result v2

    iput v2, v3, Landroid/support/b/a/i$f;->f:F

    const-string v2, "viewportHeight"

    const/16 v5, 0x8

    iget v6, v3, Landroid/support/b/a/i$f;->g:F

    invoke-static {v1, p2, v2, v5, v6}, Landroid/support/v4/a/a/g;->a(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;IF)F

    move-result v2

    iput v2, v3, Landroid/support/b/a/i$f;->g:F

    iget v2, v3, Landroid/support/b/a/i$f;->f:F
    ...
    iget v2, v3, Landroid/support/b/a/i$f;->g:F

    cmpg-float v2, v2, v5

    if-lez v2, :cond_9

    iget v2, v3, Landroid/support/b/a/i$f;->d:F

    invoke-virtual {v1, v7, v2}, Landroid/content/res/TypedArray;->getDimension(IF)F

    move-result v2

    iput v2, v3, Landroid/support/b/a/i$f;->d:F

    const/4 v2, 0x2

    iget v6, v3, Landroid/support/b/a/i$f;->e:F

    invoke-virtual {v1, v2, v6}, Landroid/content/res/TypedArray;->getDimension(IF)F

    move-result v2

    iput v2, v3, Landroid/support/b/a/i$f;->e:F
    ...
    iget v2, v3, Landroid/support/b/a/i$f;->e:F
    ...
    iput-object v2, v3, Landroid/support/b/a/i$f;->i:Ljava/lang/String;

    iget-object v5, v3, Landroid/support/b/a/i$f;->k:Landroid/support/v4/e/a;
    ...
    iput-boolean v4, v0, Landroid/support/b/a/i$g;->k:Z
    ...
    iget-object p1, v0, Landroid/support/b/a/i$g;->c:Landroid/content/res/ColorStateList;

    iget-object p2, v0, Landroid/support/b/a/i$g;->d:Landroid/graphics/PorterDuff$Mode;
...
.method protected final onStateChange([I)Z
    ...
    iget-object v0, v1, Landroid/support/b/a/i$g;->c:Landroid/content/res/ColorStateList;

    iget-object v2, v1, Landroid/support/b/a/i$g;->d:Landroid/graphics/PorterDuff$Mode;

    invoke-direct {p0, v0, v2}, Landroid/support/b/a/i;->a(Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
    ...
    :cond_1
    iget-object v2, v1, Landroid/support/b/a/i$g;->b:Landroid/support/b/a/i$f;

    invoke-virtual {v2}, Landroid/support/b/a/i$f;->a()Z
    ...
    iget-object v2, v2, Landroid/support/b/a/i$f;->c:Landroid/support/b/a/i$c;

    invoke-virtual {v2, p1}, Landroid/support/b/a/i$c;->a([I)Z

    move-result p1

    iget-boolean v2, v1, Landroid/support/b/a/i$g;->k:Z
