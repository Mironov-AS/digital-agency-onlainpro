...
.method public scanDecimal(C)Ljava/math/BigDecimal;
    ...
    :goto_a
    iget v8, v2, Lcom/alibaba/fastjson/parser/JSONLexerBase;->bp:I

    add-int/lit8 v9, v7, 0x1

    add-int/2addr v8, v7

    invoke-virtual {v2, v8}, Lcom/alibaba/fastjson/parser/JSONLexerBase;->charAt(I)C
    ...
    iput v14, v1, Lcom/alibaba/fastjson/parser/JSONLexerBase;->matchStat:I
    ...
    :goto_e
    invoke-virtual {v1, v7, v5}, Lcom/alibaba/fastjson/parser/JSONLexerBase;->sub_chars(II)[C

    move-result-object v3

    new-instance v5, Ljava/math/BigDecimal;

    invoke-direct {v5, v3}, Ljava/math/BigDecimal;-><init>([C)V
    ...
    iput v10, v1, Lcom/alibaba/fastjson/parser/JSONLexerBase;->matchStat:I

    iput v11, v1, Lcom/alibaba/fastjson/parser/JSONLexerBase;->token:I
...
.method public scanDouble(C)D
    ...
    :goto_a
    iget v7, v2, Lcom/alibaba/fastjson/parser/JSONLexerBase;->bp:I

    add-int/lit8 v8, v3, 0x1

    add-int/2addr v7, v3

    invoke-virtual {v2, v7}, Lcom/alibaba/fastjson/parser/JSONLexerBase;->charAt(I)C
    ...
    iput v12, v3, Lcom/alibaba/fastjson/parser/JSONLexerBase;->matchStat:I
    ...
    iget v7, v3, Lcom/alibaba/fastjson/parser/JSONLexerBase;->bp:I
    ...
    :cond_11
    iget v8, v3, Lcom/alibaba/fastjson/parser/JSONLexerBase;->bp:I
    ...
    :cond_12
    invoke-virtual {v3, v8, v7}, Lcom/alibaba/fastjson/parser/JSONLexerBase;->subString(II)Ljava/lang/String;
...
.method public scanFieldDecimal([C)Ljava/math/BigDecimal;
    ...
    :goto_9
    iget v9, v2, Lcom/alibaba/fastjson/parser/JSONLexerBase;->bp:I

    add-int/lit8 v12, v6, 0x1

    add-int/2addr v9, v6

    invoke-virtual {v2, v9}, Lcom/alibaba/fastjson/parser/JSONLexerBase;->charAt(I)C
    ...
    iput v15, v2, Lcom/alibaba/fastjson/parser/JSONLexerBase;->matchStat:I

    return-object v3

    :cond_11
    iget v4, v2, Lcom/alibaba/fastjson/parser/JSONLexerBase;->bp:I

    add-int/lit8 v5, v17, 0x1

    add-int v4, v4, v17

    invoke-virtual {v2, v4}, Lcom/alibaba/fastjson/parser/JSONLexerBase;->charAt(I)C

    move-result v4

    iget v6, v2, Lcom/alibaba/fastjson/parser/JSONLexerBase;->bp:I
    ...
    :cond_12
    iget v5, v2, Lcom/alibaba/fastjson/parser/JSONLexerBase;->bp:I
    ...
    :goto_d
    invoke-virtual {v2, v1, v6}, Lcom/alibaba/fastjson/parser/JSONLexerBase;->sub_chars(II)[C
    ...
    iput v10, v2, Lcom/alibaba/fastjson/parser/JSONLexerBase;->matchStat:I

    iput v11, v2, Lcom/alibaba/fastjson/parser/JSONLexerBase;->token:I
...
.method public final scanFieldDouble([C)D
    ...
    :cond_13
    invoke-virtual {v2, v7, v6}, Lcom/alibaba/fastjson/parser/JSONLexerBase;->subString(II)Ljava/lang/String;
    ...
    iput v12, v2, Lcom/alibaba/fastjson/parser/JSONLexerBase;->token:I
...
.method public final scanFieldFloat([C)F
    ...
    iput v14, v2, Lcom/alibaba/fastjson/parser/JSONLexerBase;->matchStat:I
    ...
    invoke-virtual {v2, v5}, Lcom/alibaba/fastjson/parser/JSONLexerBase;->charAt(I)C
    ...
    :cond_13
    invoke-virtual {v2, v1, v8}, Lcom/alibaba/fastjson/parser/JSONLexerBase;->subString(II)Ljava/lang/String;
    ...
    iput v3, v2, Lcom/alibaba/fastjson/parser/JSONLexerBase;->matchStat:I

    const/16 v4, 0x10

    iput v4, v2, Lcom/alibaba/fastjson/parser/JSONLexerBase;->token:I
    ...
    :goto_11
    iput v3, v2, Lcom/alibaba/fastjson/parser/JSONLexerBase;->token:I
...
.method public final scanFieldFloatArray([C)[F
    ...
    invoke-virtual {v2, v6}, Lcom/alibaba/fastjson/parser/JSONLexerBase;->charAt(I)C
    ...
    :cond_6
    iput v13, v2, Lcom/alibaba/fastjson/parser/JSONLexerBase;->matchStat:I
    ...
    :goto_7
    iget v11, v2, Lcom/alibaba/fastjson/parser/JSONLexerBase;->bp:I
    ...
    :cond_f
    invoke-virtual {v2, v9, v11}, Lcom/alibaba/fastjson/parser/JSONLexerBase;->subString(II)Ljava/lang/String;
    ...
    invoke-virtual {v2}, Lcom/alibaba/fastjson/parser/JSONLexerBase;->next()C

    iput v6, v2, Lcom/alibaba/fastjson/parser/JSONLexerBase;->matchStat:I

    const/16 v6, 0x10

    iput v6, v2, Lcom/alibaba/fastjson/parser/JSONLexerBase;->token:I
...
.method public final scanFieldFloatArray2([C)[[F
    ...
    invoke-virtual {v3, v8}, Lcom/alibaba/fastjson/parser/JSONLexerBase;->charAt(I)C
    ...
    invoke-virtual {v3, v5}, Lcom/alibaba/fastjson/parser/JSONLexerBase;->charAt(I)C
    ...
    :goto_4
    iget v12, v3, Lcom/alibaba/fastjson/parser/JSONLexerBase;->bp:I

    add-int/lit8 v16, v15, 0x1

    add-int/2addr v12, v15

    invoke-virtual {v3, v12}, Lcom/alibaba/fastjson/parser/JSONLexerBase;->charAt(I)C
    ...
    :goto_5
    iget v13, v3, Lcom/alibaba/fastjson/parser/JSONLexerBase;->bp:I

    add-int/lit8 v16, v15, 0x1

    add-int/2addr v13, v15

    invoke-virtual {v3, v13}, Lcom/alibaba/fastjson/parser/JSONLexerBase;->charAt(I)C
    ...
    invoke-virtual {v3, v4}, Lcom/alibaba/fastjson/parser/JSONLexerBase;->charAt(I)C
    ...
    :cond_e
    invoke-virtual {v3, v11, v1}, Lcom/alibaba/fastjson/parser/JSONLexerBase;->subString(II)Ljava/lang/String;
    ...
    invoke-static {v8, v11, v2, v11, v6}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V
    ...
    invoke-static {v8, v13, v12, v13, v2}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V
    ...
    invoke-static {v8, v13, v10, v13, v2}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V
    ...
    invoke-static {v10, v12, v8, v12, v2}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V
    ...
    iput v5, v3, Lcom/alibaba/fastjson/parser/JSONLexerBase;->matchStat:I

    const/16 v5, 0x10

    iput v5, v3, Lcom/alibaba/fastjson/parser/JSONLexerBase;->token:I
...
.method public final scanFloat(C)F
    ...
    iput v12, v1, Lcom/alibaba/fastjson/parser/JSONLexerBase;->matchStat:I
    ...
    iget v11, v1, Lcom/alibaba/fastjson/parser/JSONLexerBase;->bp:I
    ...
    :cond_11
    iget v13, v1, Lcom/alibaba/fastjson/parser/JSONLexerBase;->bp:I
    ...
    :cond_12
    invoke-virtual {v1, v13, v11}, Lcom/alibaba/fastjson/parser/JSONLexerBase;->subString(II)Ljava/lang/String;
...
.method public scanLong(C)J
    ...
    iput v9, v2, Lcom/alibaba/fastjson/parser/JSONLexerBase;->token:I
    ...
    iput v12, v2, Lcom/alibaba/fastjson/parser/JSONLexerBase;->matchStat:I
...
.method public final scanString()V
    ...
    const-string v2, "unclosed string : "
...
.method public scanUUID(C)Ljava/util/UUID;
    ...
    invoke-virtual {v0, v7, v2}, Lcom/alibaba/fastjson/parser/JSONLexerBase;->indexOf(CI)I
    ...
    invoke-direct {v1, v2, v3, v8, v9}, Ljava/util/UUID;-><init>(JJ)V
