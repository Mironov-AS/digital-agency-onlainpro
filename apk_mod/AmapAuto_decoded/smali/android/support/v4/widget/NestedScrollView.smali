...
.field private final y:Landroid/support/v4/f/k;

.field private final z:Landroid/support/v4/f/h;
...
.method private constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;B)V
    ...
    invoke-direct {p1, p0}, Landroid/support/v4/f/k;-><init>(Landroid/view/ViewGroup;)V

    iput-object p1, p0, Landroid/support/v4/widget/NestedScrollView;->y:Landroid/support/v4/f/k;

    new-instance p1, Landroid/support/v4/f/h;

    invoke-direct {p1, p0}, Landroid/support/v4/f/h;-><init>(Landroid/view/View;)V

    iput-object p1, p0, Landroid/support/v4/widget/NestedScrollView;->z:Landroid/support/v4/f/h;
    ...
    invoke-static {p0, p1}, Landroid/support/v4/f/m;->a(Landroid/view/View;Landroid/support/v4/f/b;)V
...
.method private a(IIII)Z
    ...
    invoke-direct {p0, p4}, Landroid/support/v4/widget/NestedScrollView;->e(I)Z
...
.method private a(IIII[II)Z
    ...
    iget-object v0, p0, Landroid/support/v4/widget/NestedScrollView;->z:Landroid/support/v4/f/h;
    ...
    invoke-virtual/range {v0 .. v6}, Landroid/support/v4/f/h;->a(IIII[II)Z
...
.method private a(II[I[II)Z
    ...
    invoke-virtual/range {v0 .. v5}, Landroid/support/v4/f/h;->a(II[I[II)Z
...
.method private c(II)Z
    ...
    invoke-virtual {v0, p1, p2}, Landroid/support/v4/f/h;->a(II)Z
...
.method private d(I)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v4/f/h;->b(I)Landroid/view/ViewParent;

    move-result-object v1

    if-eqz v1, :cond_3

    iget-object v2, v0, Landroid/support/v4/f/h;->a:Landroid/view/View;

    instance-of v3, v1, Landroid/support/v4/f/j;

    if-eqz v3, :cond_0

    check-cast v1, Landroid/support/v4/f/j;

    invoke-interface {v1, p1}, Landroid/support/v4/f/j;->b(I)V
    ...
    :cond_1
    instance-of v3, v1, Landroid/support/v4/f/i;

    if-eqz v3, :cond_2

    check-cast v1, Landroid/support/v4/f/i;

    invoke-interface {v1, v2}, Landroid/support/v4/f/i;->onStopNestedScroll(Landroid/view/View;)V

    :cond_2
    :goto_0
    const/4 v1, 0x0

    invoke-virtual {v0, p1, v1}, Landroid/support/v4/f/h;->a(ILandroid/view/ViewParent;)V
...
.method private d(II)V
    ...
    invoke-static {p0}, Landroid/support/v4/f/m;->a(Landroid/view/View;)V
...
.method private e(I)Z
    ...
    invoke-virtual {v0, p1}, Landroid/support/v4/f/h;->a(I)Z
...
.method public final a(II)V
    ...
    iget-object v0, p0, Landroid/support/v4/widget/NestedScrollView;->y:Landroid/support/v4/f/k;

    iput p1, v0, Landroid/support/v4/f/k;->a:I

    const/4 p1, 0x2

    invoke-direct {p0, p1, p2}, Landroid/support/v4/widget/NestedScrollView;->c(II)Z
...
.method public final b(I)V
    ...
    iput v1, v0, Landroid/support/v4/f/k;->a:I
...
.method public final c(I)V
    ...
    invoke-direct {p0, v0, p1}, Landroid/support/v4/widget/NestedScrollView;->d(II)V
...
.method public computeScroll()V
    ...
    invoke-direct/range {v4 .. v9}, Landroid/support/v4/widget/NestedScrollView;->a(II[I[II)Z
...
.method public dispatchNestedFling(FFZ)Z
    ...
    iget-boolean v1, v0, Landroid/support/v4/f/h;->b:Z

    const/4 v2, 0x0

    if-eqz v1, :cond_0

    invoke-virtual {v0, v2}, Landroid/support/v4/f/h;->b(I)Landroid/view/ViewParent;

    move-result-object v1

    if-eqz v1, :cond_0

    iget-object v0, v0, Landroid/support/v4/f/h;->a:Landroid/view/View;

    invoke-static {v1, v0, p1, p2, p3}, Landroid/support/v4/f/o;->a(Landroid/view/ViewParent;Landroid/view/View;FFZ)Z
...
.method public dispatchNestedPreFling(FF)Z
    ...
    invoke-static {v1, v0, p1, p2}, Landroid/support/v4/f/o;->a(Landroid/view/ViewParent;Landroid/view/View;FF)Z
...
.method public getNestedScrollAxes()I
    ...
    iget v0, v0, Landroid/support/v4/f/k;->a:I
...
.method public isNestedScrollingEnabled()Z
    ...
    iget-boolean v0, v0, Landroid/support/v4/f/h;->b:Z
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-direct {p0, v1, v4}, Landroid/support/v4/widget/NestedScrollView;->c(II)Z
...
.method public onNestedScrollAccepted(Landroid/view/View;Landroid/view/View;I)V
    ...
    invoke-virtual {p0, p3, p1}, Landroid/support/v4/widget/NestedScrollView;->a(II)V
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iput v6, v7, Landroid/support/v4/widget/NestedScrollView;->t:I

    :cond_0
    iget v1, v7, Landroid/support/v4/widget/NestedScrollView;->t:I
    ...
    iget v0, v7, Landroid/support/v4/widget/NestedScrollView;->q:I
    ...
    iput v1, v7, Landroid/support/v4/widget/NestedScrollView;->f:I

    invoke-virtual {v8, v0}, Landroid/view/MotionEvent;->getPointerId(I)I

    move-result v0

    iput v0, v7, Landroid/support/v4/widget/NestedScrollView;->q:I

    goto/16 :goto_7

    :pswitch_3
    iget-boolean v0, v7, Landroid/support/v4/widget/NestedScrollView;->j:Z
    ...
    iget-object v12, v7, Landroid/support/v4/widget/NestedScrollView;->c:Landroid/widget/OverScroller;
    ...
    :goto_0
    invoke-static/range {p0 .. p0}, Landroid/support/v4/f/m;->a(Landroid/view/View;)V

    :cond_1
    :goto_1
    iput v1, v7, Landroid/support/v4/widget/NestedScrollView;->q:I
    ...
    iget v2, v7, Landroid/support/v4/widget/NestedScrollView;->q:I
    ...
    iget-object v3, v7, Landroid/support/v4/widget/NestedScrollView;->s:[I

    iget-object v4, v7, Landroid/support/v4/widget/NestedScrollView;->r:[I
    ...
    iget-object v0, v7, Landroid/support/v4/widget/NestedScrollView;->r:[I
    ...
    iget v0, v7, Landroid/support/v4/widget/NestedScrollView;->t:I

    iget-object v1, v7, Landroid/support/v4/widget/NestedScrollView;->r:[I

    aget v1, v1, v11

    add-int/2addr v0, v1

    iput v0, v7, Landroid/support/v4/widget/NestedScrollView;->t:I
    ...
    iget v1, v7, Landroid/support/v4/widget/NestedScrollView;->n:I
    ...
    :cond_4
    iput-boolean v11, v7, Landroid/support/v4/widget/NestedScrollView;->j:Z

    if-lez v14, :cond_5

    iget v0, v7, Landroid/support/v4/widget/NestedScrollView;->n:I
    ...
    iput v13, v7, Landroid/support/v4/widget/NestedScrollView;->f:I
    ...
    invoke-direct {v7, v14, v6, v0, v15}, Landroid/support/v4/widget/NestedScrollView;->a(IIII)Z

    move-result v0

    if-eqz v0, :cond_9

    invoke-direct {v7, v6}, Landroid/support/v4/widget/NestedScrollView;->e(I)Z

    move-result v0

    if-nez v0, :cond_9

    iget-object v0, v7, Landroid/support/v4/widget/NestedScrollView;->k:Landroid/view/VelocityTracker;
    ...
    iget-object v5, v7, Landroid/support/v4/widget/NestedScrollView;->r:[I
    ...
    iget-object v0, v7, Landroid/support/v4/widget/NestedScrollView;->d:Landroid/widget/EdgeEffect;
    ...
    iget v3, v7, Landroid/support/v4/widget/NestedScrollView;->o:I

    if-le v2, v3, :cond_e

    neg-int v0, v0

    invoke-direct {v7, v0}, Landroid/support/v4/widget/NestedScrollView;->j(I)V
    ...
    :cond_f
    iget-object v0, v7, Landroid/support/v4/widget/NestedScrollView;->c:Landroid/widget/OverScroller;
    ...
    iput-boolean v0, v7, Landroid/support/v4/widget/NestedScrollView;->j:Z
    ...
    invoke-direct {v7, v0, v6}, Landroid/support/v4/widget/NestedScrollView;->c(II)Z
...
.method public requestChildRectangleOnScreen(Landroid/view/View;Landroid/graphics/Rect;Z)Z
    ...
    :cond_1
    invoke-direct {p0, p2, p1}, Landroid/support/v4/widget/NestedScrollView;->d(II)V
...
.method public setNestedScrollingEnabled(Z)V
    ...
    iget-object v1, v0, Landroid/support/v4/f/h;->a:Landroid/view/View;

    invoke-static {v1}, Landroid/support/v4/f/m;->h(Landroid/view/View;)V

    :cond_0
    iput-boolean p1, v0, Landroid/support/v4/f/h;->b:Z
