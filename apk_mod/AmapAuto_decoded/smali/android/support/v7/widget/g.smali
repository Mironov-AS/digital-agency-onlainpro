...
.field private l:Landroid/support/v4/e/i;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Landroid/support/v4/e/i<",
            "Ljava/lang/String;",
...
.method static constructor <clinit>()V
    ...
    sput-object v1, Landroid/support/v7/widget/g;->d:[I
    ...
    sput-object v2, Landroid/support/v7/widget/g;->e:[I
    ...
    sput-object v2, Landroid/support/v7/widget/g;->f:[I
...
.method private static declared-synchronized a(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
    ...
    invoke-static {p0, p1}, Landroid/support/v7/widget/g$c;->a(ILandroid/graphics/PorterDuff$Mode;)I
    ...
    invoke-virtual {v1, v2}, Landroid/support/v7/widget/g$c;->a(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {v2, p0, v1}, Landroid/support/v7/widget/g$c;->a(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    :try_end_0
...
.method private declared-synchronized a(Landroid/content/Context;J)Landroid/graphics/drawable/Drawable;
    ...
    :cond_0
    :try_start_1
    invoke-virtual {v0, p2, p3, v1}, Landroid/support/v4/e/c;->a(JLjava/lang/Object;)Ljava/lang/Object;
    ...
    :cond_1
    :try_start_2
    iget-object p1, v0, Landroid/support/v4/e/c;->c:[J

    iget v2, v0, Landroid/support/v4/e/c;->e:I

    invoke-static {p1, v2, p2, p3}, Landroid/support/v4/e/b;->a([JIJ)I

    move-result p1

    if-ltz p1, :cond_2

    iget-object p2, v0, Landroid/support/v4/e/c;->d:[Ljava/lang/Object;

    aget-object p2, p2, p1

    sget-object p3, Landroid/support/v4/e/c;->a:Ljava/lang/Object;
    ...
    iput-boolean p1, v0, Landroid/support/v4/e/c;->b:Z
    :try_end_2
...
.method public static declared-synchronized a()Landroid/support/v7/widget/g;
    ...
    invoke-direct {v1, v2, v3}, Landroid/support/v7/widget/g;->a(Ljava/lang/String;Landroid/support/v7/widget/g$d;)V
...
.method static a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/ag;[I)V
    .locals 3
    ...
    :cond_0
    iget-boolean v0, p1, Landroid/support/v7/widget/ag;->d:Z

    if-nez v0, :cond_2

    iget-boolean v0, p1, Landroid/support/v7/widget/ag;->c:Z
    ...
    iget-object v0, p1, Landroid/support/v7/widget/ag;->a:Landroid/content/res/ColorStateList;
    ...
    :goto_1
    iget-boolean v2, p1, Landroid/support/v7/widget/ag;->c:Z

    if-eqz v2, :cond_4

    iget-object p1, p1, Landroid/support/v7/widget/ag;->b:Landroid/graphics/PorterDuff$Mode;
    ...
    invoke-static {p2, p1}, Landroid/support/v7/widget/g;->a(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
...
.method private declared-synchronized a(Landroid/content/Context;JLandroid/graphics/drawable/Drawable;)Z
    ...
    invoke-virtual {v0, p2, p3, p1}, Landroid/support/v4/e/c;->b(JLjava/lang/Object;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method private b(Landroid/content/Context;ILandroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    .locals 5
    ...
    invoke-static {p3}, Landroid/support/v7/widget/s;->b(Landroid/graphics/drawable/Drawable;)Z
    ...
    :cond_0
    invoke-static {p3}, Landroid/support/v4/graphics/drawable/a;->d(Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;

    move-result-object p3

    invoke-static {p3, v0}, Landroid/support/v4/graphics/drawable/a;->a(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;)V
    ...
    invoke-static {p3, p1}, Landroid/support/v4/graphics/drawable/a;->a(Landroid/graphics/drawable/Drawable;Landroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-static {p1, v3}, Landroid/support/v7/widget/ae;->a(Landroid/content/Context;I)I

    move-result v3

    sget-object v4, Landroid/support/v7/widget/g;->a:Landroid/graphics/PorterDuff$Mode;

    invoke-static {v0, v3, v4}, Landroid/support/v7/widget/g;->a(Landroid/graphics/drawable/Drawable;ILandroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-static {v0, v2, v3}, Landroid/support/v7/widget/g;->a(Landroid/graphics/drawable/Drawable;ILandroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-static {p2, p1, v0}, Landroid/support/v7/widget/g;->a(Landroid/graphics/drawable/Drawable;ILandroid/graphics/PorterDuff$Mode;)V
    ...
    :cond_3
    invoke-static {p1, p2, p3}, Landroid/support/v7/widget/g;->a(Landroid/content/Context;ILandroid/graphics/drawable/Drawable;)Z
...
.method private declared-synchronized c(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    .locals 8
    ...
    iput-boolean v2, p0, Landroid/support/v7/widget/g;->o:Z
    ...
    instance-of v3, v0, Landroid/support/b/a/i;
    ...
    :cond_2
    iput-boolean v1, p0, Landroid/support/v7/widget/g;->o:Z
    ...
    invoke-direct {p0, p1, p2, v0}, Landroid/support/v7/widget/g;->b(Landroid/content/Context;ILandroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
...
.method private d(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, p0, Landroid/support/v7/widget/g;->l:Landroid/support/v4/e/i;

    if-eqz v0, :cond_1

    invoke-virtual {v0, p2, v1}, Landroid/support/v4/e/i;->a(ILjava/lang/Object;)Ljava/lang/Object;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/g;->l:Landroid/support/v4/e/i;
    ...
    iget-object v7, p0, Landroid/support/v7/widget/g;->l:Landroid/support/v4/e/i;

    invoke-virtual {v7, p2, v2}, Landroid/support/v4/e/i;->c(ILjava/lang/Object;)V
    ...
    iget-object p1, p0, Landroid/support/v7/widget/g;->l:Landroid/support/v4/e/i;

    const-string v0, "appcompat_skip_skip"

    invoke-virtual {p1, p2, v0}, Landroid/support/v4/e/i;->c(ILjava/lang/Object;)V
...
.method private static e(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p0, v3}, Landroid/support/v7/widget/ae;->c(Landroid/content/Context;I)I
    ...
    sget-object p0, Landroid/support/v7/widget/ae;->d:[I
    ...
    sget-object p0, Landroid/support/v7/widget/ae;->b:[I
    ...
    sget-object p0, Landroid/support/v7/widget/ae;->h:[I
...
.method final declared-synchronized a(Landroid/content/Context;Landroid/support/v7/widget/an;I)Landroid/graphics/drawable/Drawable;
    .locals 1
    ...
    invoke-virtual {p2, p3}, Landroid/support/v7/widget/an;->a(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p0, p1, p3, v0}, Landroid/support/v7/widget/g;->b(Landroid/content/Context;ILandroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
...
.method final declared-synchronized b(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p1, v3}, Landroid/support/v7/widget/ae;->b(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    sget-object v6, Landroid/support/v7/widget/ae;->a:[I
    ...
    sget-object v2, Landroid/support/v7/widget/ae;->e:[I
    ...
    sget-object v2, Landroid/support/v7/widget/ae;->h:[I
    ...
    :goto_3
    invoke-static {p1, v0}, Landroid/support/v7/widget/g;->e(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p1, v2}, Landroid/support/v7/widget/g;->e(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    :cond_8
    sget-object v0, Landroid/support/v7/widget/g;->e:[I

    invoke-static {v0, p2}, Landroid/support/v7/widget/g;->a([II)Z
    ...
    :cond_9
    sget-object v0, Landroid/support/v7/widget/g;->h:[I
    ...
    :cond_a
    sget-object v0, Landroid/support/v7/widget/g;->i:[I
    ...
    iget-object v2, p0, Landroid/support/v7/widget/g;->j:Ljava/util/WeakHashMap;

    invoke-virtual {v2, p1, v0}, Ljava/util/WeakHashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    :cond_f
    invoke-virtual {v0, p2, v1}, Landroid/support/v4/e/i;->c(ILjava/lang/Object;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
