...
# virtual methods
.method public final synthetic a(Landroid/util/AttributeSet;)Landroid/support/v7/widget/w$a;
    .locals 0
...
.method protected final synthetic b()Landroid/support/v7/widget/w$a;
    .locals 1
...
.method protected final synthetic b(Landroid/view/ViewGroup$LayoutParams;)Landroid/support/v7/widget/w$a;
    .locals 0
...
.method public getMenu()Landroid/view/Menu;
    ...
    iput-object v1, p0, Landroid/support/v7/widget/ActionMenuView;->b:Landroid/support/v7/widget/c;

    iget-object v0, p0, Landroid/support/v7/widget/ActionMenuView;->b:Landroid/support/v7/widget/c;

    const/4 v1, 0x1

    iput-boolean v1, v0, Landroid/support/v7/widget/c;->k:Z

    iput-boolean v1, v0, Landroid/support/v7/widget/c;->l:Z
    ...
    iget-object v1, p0, Landroid/support/v7/widget/ActionMenuView;->b:Landroid/support/v7/widget/c;
...
.method public getOverflowIcon()Landroid/graphics/drawable/Drawable;
    ...
    iget-object v1, v0, Landroid/support/v7/widget/c;->h:Landroid/support/v7/widget/c$d;

    if-eqz v1, :cond_0

    iget-object v0, v0, Landroid/support/v7/widget/c;->h:Landroid/support/v7/widget/c$d;
    ...
    :cond_0
    iget-boolean v1, v0, Landroid/support/v7/widget/c;->j:Z

    if-eqz v1, :cond_1

    iget-object v0, v0, Landroid/support/v7/widget/c;->i:Landroid/graphics/drawable/Drawable;
...
.method public onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    iget-object p1, p0, Landroid/support/v7/widget/ActionMenuView;->b:Landroid/support/v7/widget/c;
    ...
    invoke-virtual {p1}, Landroid/support/v7/widget/c;->c()Z
...
.method protected onMeasure(II)V
    ...
    iget v10, v12, Landroid/support/v7/widget/ActionMenuView$c;->b:I
    ...
    :cond_28
    invoke-super/range {p0 .. p2}, Landroid/support/v7/widget/w;->onMeasure(II)V
...
.method public setExpandedActionViewsExclusive(Z)V
    ...
    iput-boolean p1, v0, Landroid/support/v7/widget/c;->m:Z
...
.method public setOverflowIcon(Landroid/graphics/drawable/Drawable;)V
    ...
    iput-boolean v1, v0, Landroid/support/v7/widget/c;->j:Z

    iput-object p1, v0, Landroid/support/v7/widget/c;->i:Landroid/graphics/drawable/Drawable;
...
.method public setPresenter(Landroid/support/v7/widget/c;)V
    ...
    iput-object p1, p0, Landroid/support/v7/widget/ActionMenuView;->b:Landroid/support/v7/widget/c;
